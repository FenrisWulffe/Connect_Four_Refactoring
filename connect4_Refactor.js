...
// endGame: announce game end
  ...
  handleClick(evt) {
    if (canPlay === false) {
      alert('Must click Start Game! button to play');
      return;
    } else {
...
document.getElementById('start-game').addEventListener('click', function() {
  console.log(this.innerText, 'button has been clicked');
  let player1 = new Player(document.getElementById('player-1').value);
  console.log('Player 1 color =', player1.color);
  let player2 = new Player(document.getElementById('player-2').value);
  console.log('Player 2 color =', player2.color);
  canPlay = true;
  console.log('canPlay =', canPlay);
